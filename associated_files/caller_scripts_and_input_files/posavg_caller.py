...
posavg.main(variables["inputfiles"],variables["motif"],variables["kind"],variables["frame"],variables["bkndwindowthresh"],variables["bkndwindow"],variables["ORFnorm"],variables["shift"],variables["UTRmode"],variables["subsetlist"],variables["outfile"])