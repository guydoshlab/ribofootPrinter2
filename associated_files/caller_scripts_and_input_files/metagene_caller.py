...
# This caller script opens the txt input file, parses it, and for each SAM file specified, calls metagene.
...
metagene.main(variables["inputfiles"],variables["kind"],variables["weighting"],variables["genethresh"],variables["range5"],variables["range3"],variables["subsetlist"],variables["outfile"])